...
parser.add_argument("--geoserver", "-gs", help="The url of the GeoServer servicing the GeoGig repository.")
parser.add_argument("--workspace", "-ws", help="The GeoServer workspace to use for the data store.")
...
parser.add_argument("--authorname", "-an", help="The author name to use when merging non-conflicting branches.")
parser.add_argument("--authoremail", "-ae", help="The author email to use when merging non-conflicting branches.")
...
parser.add_argument("--timeout", "-to", type=int, default=30, help="The number of seconds to wait for the osm download task to complete before cancelling.  Default is 30 seconds.")
